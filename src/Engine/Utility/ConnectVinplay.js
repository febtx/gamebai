...
var SocialManager = cc.Class.extend({
    ...
    logout: function () {
        if (cc.sys.os == cc.sys.OS_IOS) {
           ...
           // jsb.reflection.callStaticMethod(toName("myd%pcdmzfks%~cfy%yeickf%Lkioheea_~cfy"), "logout", "()V");
        }
    ...
    loginGoogle: function () {
        ...
        if (cc.sys.os == cc.sys.OS_IOS) {
           ...
           // jsb.reflection.callStaticMethod(toName("myd%pcdmzfks%~cfy%yeickf%Meemfo_~cfy"), "getAccessToken", "()V");
        }
    ...
    loginFacebook: function () {
        ...
        if (cc.sys.os == cc.sys.OS_IOS) {
            ...
            //jsb.reflection.callStaticMethod(toName("myd%pcdmzfks%~cfy%yeickf%Lkioheea_~cfy"), "getAccessToken", "()V");
        }
        else if (cc.sys.os == cc.sys.OS_WP8) {
